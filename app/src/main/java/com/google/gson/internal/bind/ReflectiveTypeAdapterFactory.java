            ...
            while (i < length) {
                ...
                if (excludeField || excludeField2) {
                    ...
                    while (i2 < size) {
                        ...
                        Type type2 = resolve;
                        Field field2 = field;
                        boundField2 = boundField3 == null ? (BoundField) linkedHashMap.put(str, reflectiveTypeAdapterFactory2.createBoundField(gson, field, str, TypeToken.get(resolve), z3, excludeField2)) : boundField3;
                        z2 = z3;
                        resolve = type2;
                        size = i4;
                        fieldNames = list;
