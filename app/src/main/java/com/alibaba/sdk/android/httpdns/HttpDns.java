...
public class HttpDns implements HttpDnsService {
    ...
    private String[] getIpsByHost(String str) {
        if (!b.a()) {
            ...
            e m28a = hostManager.m28a(str);
            if (m28a != null && m28a.m37b() && this.isExpiredIPEnabled) {
                if (!hostManager.m33a(str)) {
                    i.d("refresh host async: " + str);
                    c.a().submit(new m(str, o.QUERY_HOST));
                }
                return m28a.m36a();
            } else if (m28a != null && !m28a.m37b()) {
                return m28a.m36a();
            } else {
    ...
    private static void reportHttpDnsSuccess(String str, int i) {
        ...
        if (a != null) {
            a.a(str, i, com.alibaba.sdk.android.httpdns.d.b.b(), com.alibaba.sdk.android.httpdns.b.b.m19a() ? 1 : 0);
        }
    }
    ...
    private static void reportUserGetIP(String str, int i) {
        com.alibaba.sdk.android.httpdns.d.a a = com.alibaba.sdk.android.httpdns.d.a.a();
        if (a != null) {
            a.b(str, i, com.alibaba.sdk.android.httpdns.d.b.b(), com.alibaba.sdk.android.httpdns.b.b.m19a() ? 1 : 0);
        }
    }
    ...
    */
    public java.lang.String[] getIpsByHostAsync(java.lang.String r7) {
        ...
        L33:
            ...
            com.alibaba.sdk.android.httpdns.e r0 = r0.m28a(r7)
            if (r0 == 0) goto L42
            boolean r3 = r0.m37b()
            if (r3 == 0) goto L7b
            goto L43
    ...
    public void setPreResolveHosts(ArrayList<String> arrayList) {
        ...
        for (int i = 0; i < arrayList.size(); i++) {
            ...
            if (k.b(str) && !hostManager.m33a(str)) {
                c.a().submit(new m(str, o.QUERY_HOST));
            }
        }
    }
