...
public class e implements IPProbeService {
    ...
    private ConcurrentHashMap<String, Long> f47b = new ConcurrentHashMap<>();
    private b a = null;
    private f b = new f() { // from class: com.alibaba.sdk.android.httpdns.probe.e.1
        ...
        public void a(long j, c cVar) {
            if (cVar != null) {
                if (!e.this.f47b.containsKey(cVar.getHostName()) || ((Long) e.this.f47b.get(cVar.getHostName())).longValue() != j) {
                    ...
                    e.this.f47b.remove(cVar.getHostName());
                }
            }
        }
    };
    ...
    public IPProbeService.a getProbeStatus(String str) {
        return this.f47b.containsKey(str) ? IPProbeService.a.PROBING : IPProbeService.a.NO_PROBING;
    }
    ...
    public void launchIPProbeTask(String str, int i, String[] strArr) {
        if (!com.alibaba.sdk.android.httpdns.a.a.a().f()) {
            ...
            long addAndGet = this.f46a.addAndGet(1L);
            this.f47b.put(str, Long.valueOf(addAndGet));
    ...
    public boolean stopIPProbeTask(String str) {
        if (this.f47b.containsKey(str)) {
            i.d("stop ip probe task for host:" + str);
            this.f47b.remove(str);
            return true;
        }
        return false;
    }
