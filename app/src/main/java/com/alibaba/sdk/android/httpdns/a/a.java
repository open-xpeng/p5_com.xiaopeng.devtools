...
public class a {
    ...
    private com.alibaba.sdk.android.httpdns.d.a f20a = null;

    /* renamed from: a  reason: collision with other field name */
    private Beacon f19a = null;
    private boolean h = true;

    /* renamed from: a  reason: collision with other field name */
    private final Beacon.OnUpdateListener f18a = new Beacon.OnUpdateListener() { // from class: com.alibaba.sdk.android.httpdns.a.a.1
    ...
    /* renamed from: a  reason: collision with other field name */
    private final Beacon.OnServiceErrListener f17a = new Beacon.OnServiceErrListener() { // from class: com.alibaba.sdk.android.httpdns.a.a.2
    ...
    public void a(Context context, String str) {
        ...
        if (this.mContext != null) {
            ...
            this.f19a = new Beacon.Builder().appKey("24657847").appSecret("f30fc0937f2b1e9e50a1b7134f1ddb10").loopInterval(7200000L).extras(hashMap).build();
            this.f19a.addUpdateListener(this.f18a);
            this.f19a.addServiceErrListener(this.f17a);
            this.f19a.start(this.mContext.getApplicationContext());
        }
    }
