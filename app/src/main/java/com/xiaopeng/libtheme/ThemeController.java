...
public class ThemeController {
    ...
    public void handleStateEvent() {
        ...
        this.mHandler.sendMessageDelayed(this.mHandler.obtainMessage(1001, isThemeWorking ? 1 : 0, 0), j);
    ...
    public void onStateChanged(boolean z) {
        ...
        setViewState(z);
        if (this.mThemeListeners != null) {
            Iterator<OnThemeListener> it = this.mThemeListeners.iterator();
            while (it.hasNext()) {
