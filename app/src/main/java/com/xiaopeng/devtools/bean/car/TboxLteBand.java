...
public class TboxLteBand {
    ...
    public List<c> toBandList() {
        ...
        arrayList.add(new c("Band1", this.Band1));
        arrayList.add(new c("Band3", this.Band3));
        arrayList.add(new c("Band5", this.Band5));
        arrayList.add(new c("Band8", this.Band8));
        arrayList.add(new c("Band34", this.Band8));
        arrayList.add(new c("Band38", this.Band8));
        arrayList.add(new c("Band39", this.Band8));
        arrayList.add(new c("Band40", this.Band8));
        arrayList.add(new c("Band41", this.Band8));
        return arrayList;
    }
