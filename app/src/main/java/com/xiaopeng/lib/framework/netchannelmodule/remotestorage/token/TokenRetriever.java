...
public final class TokenRetriever {
    ...
    public void clearToken() {
        this.mToken = null;
        c.f(TAG, "Clear the existing token!");
    }
    ...
    public class GetTokenCallback implements Callback {
        ...
        public void onFailure(IResponse iResponse) {
            ...
            c.i(TokenRetriever.TAG, "Request token error! the error message---->" + iResponse.message());
        ...
        public void onSuccess(IResponse iResponse) {
            ...
            if (asLong == 200) {
                ...
                TokenRetriever.this.callSuccessCallbacks(TokenRetriever.this.mToken);
                return;
            }
    ...
    public void callSuccessCallbacks(final Token token) {
        j.d(new Runnable() { // from class: com.xiaopeng.lib.framework.netchannelmodule.remotestorage.token.TokenRetriever.1
    ...
    public void callFailureCallbacks(final StorageException storageException) {
        j.d(new Runnable() { // from class: com.xiaopeng.lib.framework.netchannelmodule.remotestorage.token.TokenRetriever.2
            @Override // java.lang.Runnable
            public void run() {
