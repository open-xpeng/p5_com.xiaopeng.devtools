...
public class b {
    ...
    public static VuiElementType p(Object obj) {
    ...
    public static void a(final com.xiaopeng.vui.commons.a aVar, final View view, final VuiUpdateType vuiUpdateType) {
        try {
            if (mHandler == null) {
                mThread.start();
            ...
            if (mHandler != null) {
                mHandler.post(new Runnable() { // from class: com.xiaopeng.xui.vui.a.b.1
                    @Override // java.lang.Runnable
                    public void run() {
                        if (com.xiaopeng.vui.commons.a.this != null && view != null) {
                            com.xiaopeng.vui.commons.a.this.onVuiElementChaned(view, vuiUpdateType);
                        }
                    }
                });
            }
