...
public class StatMqttDelegate extends AbstractStatDelegate implements Handler.Callback {
    ...
    public void uploadCdu(final IStatEvent iStatEvent) {
        j.a(0, new Runnable() { // from class: com.xiaopeng.datalog.stat.StatMqttDelegate.1
            @Override // java.lang.Runnable
            public void run() {
                c.f(StatMqttDelegate.TAG, "uploadCdu stat:" + iStatEvent.toString());
    ...
    public void uploadCdu(final IMoleEvent iMoleEvent) {
        j.a(0, new Runnable() { // from class: com.xiaopeng.datalog.stat.StatMqttDelegate.2
            @Override // java.lang.Runnable
            public void run() {
                c.f(StatMqttDelegate.TAG, "uploadCdu mole:" + iMoleEvent.toString());
