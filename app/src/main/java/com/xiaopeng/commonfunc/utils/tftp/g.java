...
public abstract class g extends j {
    ...
    public g(InetAddress inetAddress, int i, int i2, int i3, String str, long j, int i4) {
        super(inetAddress, i, i2, i3, str, i4);
        this.pL = j;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // com.xiaopeng.commonfunc.utils.tftp.j, com.xiaopeng.commonfunc.utils.tftp.h
