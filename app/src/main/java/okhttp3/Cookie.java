...
public final class Cookie {
    ...
    */
    ...
    public int hashCode() {
        return (31 * (((((((((((((((IInputController.KEYCODE_KNOB_TALKING_BOOK + this.name.hashCode()) * 31) + this.value.hashCode()) * 31) + this.domain.hashCode()) * 31) + this.path.hashCode()) * 31) + ((int) (this.expiresAt ^ (this.expiresAt >>> 32)))) * 31) + (!this.secure ? 1 : 0)) * 31) + (!this.httpOnly ? 1 : 0)) * 31) + (!this.persistent ? 1 : 0))) + (!this.hostOnly ? 1 : 0);
    }
}
