...
public final class ConnectionSpec {
    ...
    public int hashCode() {
        if (this.tls) {
            return (31 * (((IInputController.KEYCODE_KNOB_TALKING_BOOK + Arrays.hashCode(this.cipherSuites)) * 31) + Arrays.hashCode(this.tlsVersions))) + (!this.supportsTlsExtensions ? 1 : 0);
        }
        return 17;
    }
