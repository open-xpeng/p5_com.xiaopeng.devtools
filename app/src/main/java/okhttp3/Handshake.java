...
public final class Handshake {
    ...
    public int hashCode() {
        return (31 * (((((IInputController.KEYCODE_KNOB_TALKING_BOOK + this.tlsVersion.hashCode()) * 31) + this.cipherSuite.hashCode()) * 31) + this.peerCertificates.hashCode())) + this.localCertificates.hashCode();
    }
}
