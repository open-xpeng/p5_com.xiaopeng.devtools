...
public class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    */
    ...
    boolean dispatchKeyEvent(KeyEvent keyEvent) {
        boolean z;
        View decorView = this.mWindow.getDecorView();
        if (ViewCompat.dispatchUnhandledKeyEventPre(decorView, keyEvent)) {
            return true;
        }
        ...
        if (!z ? onKeyUp(keyCode, keyEvent) : onKeyDown(keyCode, keyEvent)) {
            return ViewCompat.dispatchUnhandledKeyEventPost(decorView, keyEvent);
        }
        return true;
    }
