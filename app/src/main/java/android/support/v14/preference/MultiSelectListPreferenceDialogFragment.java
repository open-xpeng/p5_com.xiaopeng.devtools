    ...
    public void onPrepareDialogBuilder(AlertDialog.Builder builder) {
        ...
        builder.setMultiChoiceItems(this.mEntries, zArr, new DialogInterface.OnMultiChoiceClickListener() { // from class: android.support.v14.preference.MultiSelectListPreferenceDialogFragment.1
            ...
            public void onClick(DialogInterface dialogInterface, int i2, boolean z) {
                if (z) {
                    MultiSelectListPreferenceDialogFragment.this.mPreferenceChanged = MultiSelectListPreferenceDialogFragment.this.mNewValues.add(MultiSelectListPreferenceDialogFragment.this.mEntryValues[i2].toString()) | MultiSelectListPreferenceDialogFragment.this.mPreferenceChanged;
                    return;
                }
                MultiSelectListPreferenceDialogFragment.this.mPreferenceChanged = MultiSelectListPreferenceDialogFragment.this.mNewValues.remove(MultiSelectListPreferenceDialogFragment.this.mEntryValues[i2].toString()) | MultiSelectListPreferenceDialogFragment.this.mPreferenceChanged;
            }
        });
    }
