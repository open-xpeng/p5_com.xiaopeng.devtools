...
public abstract class PreferenceFragment extends Fragment implements DialogPreference.TargetFragment, PreferenceManager.OnDisplayPreferenceDialogListener, PreferenceManager.OnNavigateToScreenListener, PreferenceManager.OnPreferenceTreeClickListener {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        TypedArray obtainStyledAttributes = this.mStyledContext.obtainStyledAttributes(null, android.support.v7.preference.R.styleable.PreferenceFragment, TypedArrayUtils.getAttr(this.mStyledContext, android.support.v7.preference.R.attr.preferenceFragmentStyle, AndroidResources.ANDROID_R_PREFERENCE_FRAGMENT_STYLE), 0);
        this.mLayoutResId = obtainStyledAttributes.getResourceId(android.support.v7.preference.R.styleable.PreferenceFragment_android_layout, this.mLayoutResId);
