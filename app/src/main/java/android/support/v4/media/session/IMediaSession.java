    ...
    public static abstract class Stub extends Binder implements IMediaSession {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            if (i == 51) {
                ...
                rateWithExtras(ratingCompat, parcel.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(parcel) : null);
                ...
                switch (i) {
                    case 1:
                        ...
                        sendCommand(readString, bundle, parcel.readInt() != 0 ? MediaSessionCompat.ResultReceiverWrapper.CREATOR.createFromParcel(parcel) : null);
                        parcel2.writeNoException();
                        return true;
                    case 2:
                        parcel.enforceInterface(DESCRIPTOR);
