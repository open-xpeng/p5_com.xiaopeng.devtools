...
public class NestedScrollView extends FrameLayout implements NestedScrollingChild2, NestedScrollingParent2, ScrollingView {
    ...
    public boolean executeKeyEvent(@NonNull KeyEvent keyEvent) {
        ...
        if (!canScroll) {
            ...
            View findNextFocus = FocusFinder.getInstance().findNextFocus(this, findFocus, Cea708CCParser.Const.CODE_C1_CW2);
            return (findNextFocus == null || findNextFocus == this || !findNextFocus.requestFocus(Cea708CCParser.Const.CODE_C1_CW2)) ? false : true;
