    ...
    */
    private static android.graphics.Typeface loadFont(@android.support.annotation.NonNull android.content.Context r14, android.content.res.Resources r15, android.util.TypedValue r16, int r17, int r18, @android.support.annotation.Nullable android.support.v4.content.res.ResourcesCompat.FontCallback r19, @android.support.annotation.Nullable android.os.Handler r20, boolean r21) {
        ...
        L30:
            return r1
        L31:
            java.lang.String r1 = r11.toLowerCase()     // Catch: java.io.IOException -> L71 org.xmlpull.v1.XmlPullParserException -> L89
            java.lang.String r2 = ".xml"
            boolean r1 = r1.endsWith(r2)     // Catch: java.io.IOException -> L71 org.xmlpull.v1.XmlPullParserException -> L89
            if (r1 == 0) goto L60
            android.content.res.XmlResourceParser r1 = r0.getXml(r4)     // Catch: java.io.IOException -> L71 org.xmlpull.v1.XmlPullParserException -> L89
            android.support.v4.content.res.FontResourcesParserCompat$FamilyResourceEntry r2 = android.support.v4.content.res.FontResourcesParserCompat.parse(r1, r0)     // Catch: java.io.IOException -> L71 org.xmlpull.v1.XmlPullParserException -> L89
            if (r2 != 0) goto L55
            java.lang.String r0 = "ResourcesCompat"
            java.lang.String r1 = "Failed to find font-family tag"
            android.util.Log.e(r0, r1)     // Catch: java.io.IOException -> L71 org.xmlpull.v1.XmlPullParserException -> L89
            if (r9 == 0) goto L54
            r9.callbackFailAsync(r13, r10)     // Catch: java.io.IOException -> L71 org.xmlpull.v1.XmlPullParserException -> L89
        L54:
            return r12
        L55:
            r1 = r14
            ...
            r7 = r10
            r8 = r21
            android.graphics.Typeface r0 = android.support.v4.graphics.TypefaceCompat.createFromResourcesFamilyXml(r1, r2, r3, r4, r5, r6, r7, r8)     // Catch: java.io.IOException -> L71 org.xmlpull.v1.XmlPullParserException -> L89
            return r0
        L60:
            r1 = r14
            android.graphics.Typeface r0 = android.support.v4.graphics.TypefaceCompat.createFromResourcesFontFile(r1, r0, r4, r11, r5)     // Catch: java.io.IOException -> L71 org.xmlpull.v1.XmlPullParserException -> L89
            if (r9 == 0) goto L70
            if (r0 == 0) goto L6d
            r9.callbackSuccessAsync(r0, r10)     // Catch: java.io.IOException -> L71 org.xmlpull.v1.XmlPullParserException -> L89
            goto L70
        L6d:
            r9.callbackFailAsync(r13, r10)     // Catch: java.io.IOException -> L71 org.xmlpull.v1.XmlPullParserException -> L89
        L70:
