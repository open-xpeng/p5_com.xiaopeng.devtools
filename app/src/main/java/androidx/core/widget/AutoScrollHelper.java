...
public abstract class AutoScrollHelper implements View.OnTouchListener {
    ...
    public AutoScrollHelper(@NonNull View view) {
        ...
        float f = (int) ((1575.0f * displayMetrics.density) + 0.5f);
        setMaximumVelocity(f, f);
        float f2 = (int) ((315.0f * displayMetrics.density) + 0.5f);
        ...
        setRampUpDuration(IInputController.KEYCODE_KNOB_WIND_SPD_UP);
        setRampDownDuration(IInputController.KEYCODE_KNOB_WIND_SPD_UP);
    }
